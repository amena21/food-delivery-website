      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <form action="{{url('/updatefullmenu',$data->id)}}" method="post" enctype="multipart/form-data">
                @csrf 
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" id="inputDescription" class="form-control" name="price" value="{{$data->price}}" required>
                  </div>
                  <div class="form-group">
              ...
              <div class="form-group">
                ...
                <img style="height:150px;width:150px;" src="/fullmenuimage/{{$data->image}}">
